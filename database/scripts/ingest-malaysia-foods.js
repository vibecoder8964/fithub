/**
 * ingest-malaysia-foods.js
 * Ingests the malaysia_healthy_foods_800.sql file into the Supabase Postgres database.
 */
...
async function main() {
    ...
    try {
        ...
        const sqlPath = join(__dirname, "..", "..", "malaysia_healthy_foods_800.sql");
        ...
        console.log("✅ Successfully ingested all 800 Malaysia Healthy Foods!");
